export default {
  ...
  'status.compressingPromptSelection': 'Сжатие prompt...',
  ...
  'status.promptCompressionFailed': 'Ошибка сжатия prompt',
  'status.promptCompressionCancelled': 'Сжатие prompt отменено',
  ...
  'appSettings.promptCompression': 'Сжатие prompt',
  ...
  'hotkey.promptCompression': 'Сжатие prompt',
  ...
  'error.noTextSelectedToCompressPrompt': 'Нет текста для сжатия',
  'error.translationInProgress': 'Перевод уже выполняется',
  'error.noPrettifyResult': 'В ответе нет улучшенного текста',
  'error.noPromptCompressionResult': 'В ответе нет сжатого prompt',
