export default {
  ...
  'status.compressingPromptSelection': 'Стиснення prompt...',
  ...
  'status.promptCompressionFailed': 'Помилка стиснення prompt',
  'status.promptCompressionCancelled': 'Стиснення prompt скасовано',
  ...
  'appSettings.promptCompression': 'Стиснення prompt',
  ...
  'hotkey.promptCompression': 'Стиснення prompt',
  ...
  'error.noTextSelectedToCompressPrompt': 'Немає тексту для стиснення',
  'error.translationInProgress': 'Переклад уже виконується',
  'error.noPrettifyResult': 'У відповіді немає покращеного тексту',
  'error.noPromptCompressionResult': 'У відповіді немає стисненого prompt',
