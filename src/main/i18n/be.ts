export default {
  ...
  'status.compressingPromptSelection': 'Сцісканне prompt...',
  ...
  'status.promptCompressionFailed': 'Памылка сціскання prompt',
  'status.promptCompressionCancelled': 'Сцісканне prompt скасавана',
  ...
  'appSettings.promptCompression': 'Сцісканне prompt',
  ...
  'hotkey.promptCompression': 'Сцісканне prompt',
  ...
  'error.noTextSelectedToCompressPrompt': 'Няма тэксту для сціскання',
  'error.translationInProgress': 'Пераклад ужо выконваецца',
  'error.noPrettifyResult': 'У адказе няма палепшанага тэксту',
  'error.noPromptCompressionResult': 'У адказе няма сціснутага prompt',
