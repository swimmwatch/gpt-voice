export default {
  ...
  'status.resendingTranscription': 'Retrying transcription...',
  'status.translating': 'Translating...',
  'status.translatingSelection': 'Translating selection...',
  'status.prettifyingSelection': 'Prettifying selection...',
  'status.compressingPromptSelection': 'Compressing prompt...',
  ...
  'status.promptCompressionFailed': 'Prompt compression failed',
  'status.promptCompressionCancelled': 'Prompt compression cancelled',
  ...
  'appSettings.promptCompression': 'Prompt Compression',
  ...
  'hotkey.promptCompression': 'Prompt compression',
  'hotkey.retryTranscription': 'Retry transcription',
  ...
  'error.noTextSelectedToCompressPrompt': 'No text selected to compress',
  'error.translationInProgress': 'Translation already in progress',
  'error.noPrettifyResult': 'No prettified text in response',
  'error.noPromptCompressionResult': 'No compressed prompt in response',
