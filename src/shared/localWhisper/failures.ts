...
export const LOCAL_WHISPER_FAILURE_DESCRIPTORS = Object.freeze({
  ...
  DEVICE_PROOF_FAILED: descriptor('device', true, 'refresh-and-retry', 'capabilityNotReady'),
  ALLOCATION_FAILED: descriptor('allocation', true, 'retry-load-or-change-settings', 'capabilityNotReady'),
  MODEL_AUTHORITY_INVALID: descriptor('modelLoad', true, 'retry-load-or-change-settings', 'residencyFailed'),
  MODEL_LOAD_FAILED: descriptor('modelLoad', false, 'update-or-change-model', 'residencyFailed'),
