...
function SheetOverlay({ className, ...props }: React.ComponentProps<typeof SheetPrimitive.Overlay>) {
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn('landing-sheet-overlay fixed inset-0 z-50 bg-[var(--overlay)]', className)}
      {...props}
    />
  );
}
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        data-side={side}
        className={cn(
          'landing-sheet-content fixed z-50 flex flex-col gap-4 bg-background shadow-[var(--shadow-media)]',
          side === 'right' &&
