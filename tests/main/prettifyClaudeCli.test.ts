...
describe('ClaudeCliPrettifyAdapter', () => {
  ...
  it('maps every runner failure without exposing diagnostics or failed process output', async () => {
    ...
    const cases: Array<[CliProcessFailureCode, ClaudeCliPrettifyErrorCode]> = [
      ...
      [CliProcessFailureCode.StdoutLimit, ClaudeCliPrettifyErrorCode.OutputLimit],
      [CliProcessFailureCode.StderrLimit, ClaudeCliPrettifyErrorCode.OutputLimit],
      [CliProcessFailureCode.NonzeroExit, ClaudeCliPrettifyErrorCode.NonzeroExit],
