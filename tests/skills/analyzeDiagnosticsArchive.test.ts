...
describe('diagnostics archive closed schema reference', () => {
  ...
  it('documents exact provider-audit fields, enums, operations, and metadata allowlist', () => {
    ...
    assertContainsEvery(reference, [
      ...
      '`local-model-load`',
      '`local-model-unload`',
      '`transcribe-batch`, `transcribe-stream`, `recovery`',
      ...
      'activitystate, artifactkind, artifactrevision, backend, bytecount, capabilitystate',
      'engineid, errorclass, exceptiontype, failurecode',
      'modelconfigured, modelfamily, modelnamelength, modelsource',
      'recoveryscheduled, residencystate, resultlength, retryscheduled, runtimerevision',
      'setupstate, sourcelength, supporttier, target, targetlanguage',
