...
description: Use only when the user explicitly requests logging, metrics, tracing, alerting, or production diagnosability work.
---
...
For the at-a-glance version of this list, including the pre-launch instrumentation gate, see `.agents/references/observability-checklist.md`.
