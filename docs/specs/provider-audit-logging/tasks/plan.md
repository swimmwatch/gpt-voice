...
| [21 About diagnostics export](21_integrate_about_diagnostics_export.md)               | About-only trusted IPC owns save dialog, export orchestration, notifications, close, and retry                             | 20                    | `UI-001`–`UI-003`; additive IPC `COMP-003`                                                                                                                                                                                          |
