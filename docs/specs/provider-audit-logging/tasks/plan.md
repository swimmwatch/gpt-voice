...
| [09 Desktop controllers DI](09_migrate_desktop_controllers_di.md)                     | Windows, tray, shortcuts, protocol, startup, metadata, and Linux desktop state become application-owned                   | 08                    | Approved DI decisions; existing desktop/security compatibility contracts                                                                                                                                                            |
...
| [15 Config and localization DI](15_migrate_config_and_localization_di.md)             | Configuration snapshots, persistence, and locale state become isolated application-owned services                         | 08–14                 | Approved DI decisions; existing config/locale compatibility contracts                                                                                                                                                               |
| [16 Runtime adapters](16_migrate_runtime_adapters.md)                                 | Logger, Electron, and CloakBrowser runtime caches become isolated application-owned adapters                              | 08–15                 | Approved DI decisions; existing logging/runtime/privacy compatibility contracts                                                                                                                                                     |
| [17 Project DI enforcement](17_enforce_project_di_boundaries.md)                      | Transitional stateful globals are removed and static architecture checks enforce the final boundaries                      | 08–16                 | All approved DI decisions and integrated compatibility/privacy coverage                                                                                                                                                             |
| [18 Audit Log settings and deletion](18_add_audit_log_settings_and_deletion.md)       | Default-off capture toggles, confirmed disable/purge, clear actions, trusted IPC, UI, and locale coverage                  | 07, 17                | `DATA-001`; `DATA-004`–`DATA-005`; `UI-004`–`UI-005`; `SEC-006`; settings `COMP-003`                                                                                                                                                |
| [19 Translation and Prettify capture](19_integrate_translation_prettify_capture.md)   | Every successful provider/cache action stores exactly one safe row when enabled                                            | 02, 05–07, 13, 14, 18 | `DATA-002`; `DATA-006`; `SEC-005`–`SEC-007`; `FAIL-002`–`FAIL-003`; capture `PRETTY-005`, `COMP-001`                                                                                                                                |
| [20 Diagnostics archive core](20_build_diagnostics_archive_core.md)                   | Valid audit events, safe manifest data, and enabled diagnostic rows are atomically written as ZIP or tar.gz                | 01, 07, 17, 18        | `SCOPE-003`; `EXPORT-001`–`EXPORT-005`; `SEC-004`–`SEC-005`; `SEC-008`; archive `OPS-001`                                                                                                                                           |
| [21 Audit Log diagnostics export](21_integrate_about_diagnostics_export.md)           | Settings-only trusted IPC owns save dialog, export orchestration, notifications, single-flight control, and retry           | 20                    | `UI-001`–`UI-003`; additive IPC `COMP-003`                                                                                                                                                                                          |
| [22 Diagnostics analysis skill](22_create_diagnostics_analysis_skill.md)              | A validated repository skill inspects untrusted archives and produces a bounded evidence-linked report                     | 20                    | `SKILL-001`–`SKILL-005`; `SEC-009`; analysis `NONGOAL-001`                                                                                                                                                                          |
| [23 Integration gate](23_document_and_run_integration_gate.md)                        | Documentation, cross-surface privacy/regression coverage, dependency audit, and production build pass                      | 02–22                 | Remaining `SEC-001`–`SEC-009`, `COMP-001`–`COMP-003`, `NONGOAL-001`–`NONGOAL-003`, `AC-AUTO-001`                                                                                                                                    |
| [24 Sanitized manual verification](24_complete_sanitized_manual_verification.md)      | Authorized Linux/Windows checks prove the packaged flow with synthetic content                                             | 23                    | `AC-MAN-001` and sanitized manual acceptance                                                                                                                                                                                        |
...
01 Audit core ─┬─> 02 Translation audit ───────────────┐
               ...
               └─> 07 Repositories ─> 08 Main root ─> 09 Desktop
                                                        -> 10 Voice/Browser
                                                        -> 11 Translation
                                                        -> 12 Prettify
                                                        -> 13 Main IPC
...
one explicit owner; Tasks 08–17 additionally own the approved project-wide DI
