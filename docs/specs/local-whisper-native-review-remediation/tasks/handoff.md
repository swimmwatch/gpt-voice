...
- Complete Packet 12's code-bearing exact-SHA Linux and Windows remote gate. Do not begin Packet 13 until Packet 12 is checked and its documentation-only closeout is pushed.
