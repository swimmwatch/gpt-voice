...
`d43fcc70`. Packet 07 is complete and remains uncommitted for review. Packet 06 remains
a later supported-platform manual gate and requires a later explicit implementation
authorization.
