...
Packets 01–02 are committed and Packet 03 is complete but intentionally uncommitted
for review. Every remaining packet requires its own explicit
`incremental-implementation` authorization. Before another packet may start, Packet 03
