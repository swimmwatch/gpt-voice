...
- `npm run landing:test:e2e` (ten English browser scenarios pass, including blocked hydration/Plyr chunks plus keyboard, responsive, reduced-motion, forced-colors, and sticky-anchor coverage).
