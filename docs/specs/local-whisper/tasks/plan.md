...
- Task 08 is the only native-source and toolchain-lock foundation. It adds the
  complete pinned GoogleTest tree and proves Clang/ASan/UBSan activation with a
  dependency-free sanitizer fixture; it leaves the protocol/supervisor
