...
| 5     | [05 First-launch review remediation](05_first-launch-review-remediation.md)       | Repair provider startup gating, Retry lifecycle, loader reuse/accessibility, tests, and formatting.                            | 01–04                  | FLR-007, FLR-010, FLR-014–FLR-017                          |
| 6     | [06 Reveal stage-aware startup loader](06_reveal_stage_aware_startup_loader.md)   | Yield the static bootstrap shell to the existing localized React loading screen while represented startup work remains active. | 05                     | FLR-018                                                    |

Safe sequence is 01 → 02 → 03 → 04 → 05 → 06. Each packet must pass its scoped checks and update [todo.md](todo.md) plus [handoff.md](handoff.md) before the next packet begins.
