...
Safe sequence is 01 → 02 → 03 → 04 → 05. Each packet must pass its scoped checks and update [todo.md](todo.md) plus [handoff.md](handoff.md) before the next packet begins.
